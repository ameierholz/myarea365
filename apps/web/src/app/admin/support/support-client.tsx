...
const DEMO_TICKETS: Ticket[] = [
  ...
  { id: "d5", email: "zephyr@example.com", name: "Zephyr", subject: "Wie funktioniert das Saison-Begleiter-System?", body: "Ich habe gerade meinen Saison-Begleiter gewählt, aber mein alter Begleiter ist jetzt Level 1?", category: "general", status: "resolved", priority: "low", created_at: new Date(Date.now() - 3 * 86400_000).toISOString(), resolved_at: new Date(Date.now() - 2 * 86400_000).toISOString(), internal_notes: "Saison-Begleiter vs. Ewiger Begleiter erklärt — User zufrieden", source: "contact_form" },
