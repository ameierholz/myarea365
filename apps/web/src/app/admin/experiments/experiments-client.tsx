...
const DEMO_EXPERIMENTS: Experiment[] = [
  { id: "d1", key: "onboarding_v2", description: "Vereinfachter Begleiter-Pick-Flow beim ersten Login", variants: [{ key: "control", weight: 50 }, { key: "simplified", weight: 50 }], status: "running", started_at: new Date(Date.now() - 12 * 86400_000).toISOString(), ended_at: null, created_at: new Date(Date.now() - 15 * 86400_000).toISOString(), assignments: 1842 },
