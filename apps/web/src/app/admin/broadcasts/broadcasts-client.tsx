...
const DEMO_BROADCASTS: Broadcast[] = [
  { id: "d1", title: "⚔️ Arena-Saison 2 startet!", body: "Wähle deinen Saison-Begleiter und kämpfe in der Arena um Ehre und Prestige. Jetzt live!", channel: "push", segment: { min_level: 5 }, recipient_count: 1847, status: "sent", sent_at: new Date(Date.now() - 3 * 86400_000).toISOString(), sent_by_email: "admin@myarea365.de", created_at: new Date(Date.now() - 3 * 86400_000).toISOString() },
