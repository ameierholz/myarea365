...
/**
 * POST /api/base/instant-finish
 * Body: { queue_id: string }
 *
 * Bezahlt Sofort-Fertigstellung eines Build-Queue-Eintrags mit Diamanten
...
export async function POST(req: Request) {
  ...
  const { data, error } = await sb.rpc("instant_finish_queue_with_gems", { p_queue_id: body.queue_id });
