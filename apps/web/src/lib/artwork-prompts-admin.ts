...
export const BUILDINGS_ART: BuildingArt[] = [
  ...
  { id: "wegekasse",      name: "Mautstation",            category: "storage",    emoji: "\u{1F3E6}",
    ...
    facing: "NE" },
  { id: "wald_pfad",      name: "Park-Pfad",              category: "production", emoji: "\u{1F332}",
  ...
  { id: "waechter_halle", name: "Wächter-Halle",          category: "combat",     emoji: "\u{1F6E1}️",
    ...
    facing: "SE" },
  { id: "laufturm",       name: "Lauf-Türme",             category: "utility",    emoji: "\u{1F5FC}",
    ...
    facing: "SW" },
  { id: "lagerhalle",     name: "Lauf-Lager",             category: "storage",    emoji: "\u{1F4E6}",
  ...
  { id: "schmiede",       name: "Modding-Shop",           category: "utility",    emoji: "⚒️",
    ...
    facing: "NW" },
  { id: "gasthaus",       name: "Rast-Kiosk",             category: "production", emoji: "\u{1F37B}",
  ...
  { id: "saegewerk",      name: "Recycling-Hof",          category: "production", emoji: "♻️",
    ...
    facing: "NE" },
  { id: "steinbruch",     name: "Komponenten-Werk",       category: "production", emoji: "\u{1F529}",
    ...
    facing: "NW" },
  { id: "goldmine",       name: "Krypto-Mine",            category: "production", emoji: "\u{1F4B8}",
    ...
    facing: "SE" },
  { id: "mana_quelle",    name: "Datacenter",             category: "production", emoji: "\u{1F4E1}",
  ...
  { id: "tresorraum",     name: "Geheim-Tresor",          category: "storage",    emoji: "\u{1F3DB}️",
    ...
    facing: "NE" },
  { id: "kornkammer",     name: "Vorrats-Depot",          category: "storage",    emoji: "\u{1F33E}",
  ...
  { id: "trainingsplatz", name: "Übungs-Hof",             category: "combat",     emoji: "\u{1F94B}",
    ...
    facing: "NE" },
  { id: "ballistenwerk",  name: "Wurfgeschütz-Werk",      category: "combat",     emoji: "\u{1F3AF}",
  ...
  { id: "schwarzes_brett",name: "Quest-Tafel",            category: "utility",    emoji: "\u{1F4CB}",
    ...
    facing: "SW" },
  { id: "halbling_haus",  name: "Bau-Büro",              category: "utility",    emoji: "\u{1F3DA}️",
  ...
  { id: "truhenkammer",   name: "Truhen-Depot",           category: "storage",    emoji: "\u{1F5DD}️",
    ...
    facing: "SE" },
  { id: "arena_halle",    name: "Arena-Halle",            category: "combat",     emoji: "\u{1F3DF}️",
  ...
  { id: "spaeher_wachposten",name: "Späher-Posten",       category: "combat",     emoji: "\u{1F441}️",
    ...
    facing: "SE" },
  { id: "sammel_leuchtfeuer",name: "Signal-Bake",          category: "combat",     emoji: "\u{1F525}",
    ...
    facing: "SW" },
  { id: "crew_taverne",   name: "Crew-Bar",               category: "production", emoji: "\u{1F37B}",
  ...
  { id: "tempel_himmlisch",name: "Funkturm",              category: "combat",     emoji: "\u{1F4E1}",
    ...
    facing: "SW" },
  { id: "goblin_markt",   name: "Schwarzmarkt",           category: "utility",    emoji: "\u{1F47A}",
