...
export function buildNameplatePrompt(input: {
  ...
  if (input.mode === "video") {
    return [
      ...
      `TOP horizontal strip (top ~32% of canvas height — thicker, prominent): a continuous decorative band running the FULL WIDTH edge-to-edge. From this top band, decorative growths extend UPWARD into the area above the band — spikes, horns, vines, thorns, jagged crystals, twisting branches, claws, sigils, glowing shards. These growths can be ASYMMETRIC and VARIED along the width (different heights, different shapes, not a repeated tile pattern). Theme-appropriate to ${themeWord}.`,
      `BOTTOM horizontal strip (bottom ~32% of canvas height — thicker, prominent): mirrors the design language of the top band, with growths extending DOWNWARD. Decorative drips, roots, hanging chains, downward spikes, dripping vines, claws — varied, asymmetric, theme-matched.`,
      `MIDDLE empty zone (~36% of canvas height, full width between the top and bottom strips — JUST big enough for a single line of text, no excess gap): completely empty pure GREEN #00FF00 — NO graphics, NO decoration, NO text, NO shading, NO frame border crossing through it. Just empty green that becomes transparent at render. This is where the runner-name goes.`,
  ...
  return [
    ...
    `TOP horizontal strip (top ~32% of canvas height — thicker, prominent): continuous decorative band edge-to-edge. From this band, decorative growths extend UPWARD into the area above — varied spikes, horns, twisting vines, jagged thorns, glowing crystal shards, claws, sigils, dripping flames — ASYMMETRIC and varied along the width (NOT a uniform repeated tile, but a designed silhouette with different heights and shapes at different positions). Theme-appropriate to ${themeWord}.`,
    `BOTTOM horizontal strip (bottom ~32% of canvas height — thicker, prominent): complementary design language to the top, with growths extending DOWNWARD — drips, roots, hanging chains, downward spikes, dripping vines, claws. Varied and asymmetric.`,
    `MIDDLE empty zone (~36% of canvas height, full width between the strips — text-line height, no excess vertical gap): completely empty pure GREEN #00FF00. NO content of any kind. This area becomes transparent.`,
