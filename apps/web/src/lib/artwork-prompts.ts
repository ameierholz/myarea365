...
export const STRONGHOLDS_ART: StrongholdArt[] = [
  {
    ...
    fallbackEmoji: "🏰",
    accent: "#FF2D78",
    subject: "a fortified urban bandit lair built into the husk of an ABANDONED MEDIEVAL GATEHOUSE-RUIN that has been crudely rebuilt with stacked shipping containers, improvised concrete barriers and rusted iron sheets — crooked multi-tiered watchtower with leaning sniper-perches, makeshift battlements of old tires and razor-wire, ominous red lanterns and hostile graffiti tags (skull crew-mark, X-marks dripping like blood), boarded windows with hellish red glow inside, splintered wooden gate barely hanging on iron hinges, a small mountain of looted spoils piled at the base (gold coins spilling from a chest, a tipped-over ale-keg, broken weapons, abandoned merchant carts) — composition: irregular crumbling stone foundation as platform (NOT a clean square tile), the building rises asymmetrically with a tall lookout tower projecting upward and a wide barricaded gate-section spreading wide, strong silhouette readable from a distance — hostile aggressive vibe: clearly a place travelers should avoid",
    style: "AAA mobile-game promotional hero-shot — cinematic, ultra-detailed, intricate hand-painted texture work, dramatic rim-light, atmospheric haze, awe-inspiring presence, the kind of asset you'd see on a key-art splash screen or trailer-thumbnail (NOT a generic mid-tier mobile icon). Reference standard: Rise of Kingdoms / Call of Dragons / Watcher of Realms / Lords Mobile premium hero-art. Vibrant saturated colors with dominant crimson/magenta accents (#FF2D78) and warm orange torch glow, slight cel-shading, painterly highlights, irregular crumbling stone-foundation platform.\n\nHERO FEATURE (the WOW moment — render this BIG and prominent): a COLOSSAL SKULL-AND-CROSSED-AXES BANNER (the crew-mark of the bandit clan) flies in tatters from the top of the watchtower, woven from blood-red silk that snaps in an unfelt wind — the banner is twice the size of any normal flag, its edges torn into menacing fangs, and a translucent ghostly wraith of red smoke seeps out from the gatehouse archway behind the broken gate, its eyes glowing bright red, signalling 'HERE BE DANGER' from across the map"
  },
];
