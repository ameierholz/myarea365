...
export const UNLOCKABLE_MARKERS = [
  ...
  { id: "cat",         icon: "🐈",  cost: 9000,      name: "Katze"         },
  { id: "fox",         icon: "🦊",  cost: 13000,     name: "Fuchs"         },
  { id: "deer",        icon: "🦌",  cost: 18000,     name: "Hirsch"        },
  { id: "wolf",        icon: "🐺",  cost: 25000,     name: "Wolf"          },
  { id: "bear",        icon: "🐻",  cost: 35000,     name: "Bär"           },
  { id: "horse",       icon: "🐎",  cost: 50000,     name: "Pferd"         },
  { id: "cheetah",     icon: "🐆",  cost: 70000,     name: "Gepard"        },
  { id: "tiger",       icon: "🐅",  cost: 95000,     name: "Tiger"         },
  { id: "lion",        icon: "🦁",  cost: 125000,    name: "Löwe"          },
  { id: "elephant",    icon: "🐘",  cost: 160000,    name: "Elefant"       },
  { id: "gorilla",     icon: "🦍",  cost: 210000,    name: "Gorilla"       },
  { id: "bat",         icon: "🦇",  cost: 280000,    name: "Fledermaus"    },
  { id: "owl",         icon: "🦉",  cost: 360000,    name: "Eule"          },
  { id: "dove",        icon: "🕊️",  cost: 460000,    name: "Taube"         },
  { id: "butterfly",   icon: "🦋",  cost: 600000,    name: "Schmetterling" },
  { id: "swan",        icon: "🦢",  cost: 780000,    name: "Schwan"        },
  { id: "eagle",       icon: "🦅",  cost: 1000000,   name: "Adler"         },
  { id: "ghost",       icon: "👻",  cost: 1300000,   name: "Geist"         },
...
export const GENDERED_VARIANT_OPTIONS: Array<"male" | "female"> = ["male", "female"];
...
export const ACHIEVEMENTS: Array<{
  ...
  { id: "dist_1",  name: "Erster Kilometer",      xp: 50,     icon: "👣", stat: "longest_km",  target: 1,    unit: "km", category: "distance", tier: "easy" },
  { id: "dist_9",  name: "2 km geschafft",        xp: 80,     icon: "🚶", stat: "longest_km",  target: 2,    unit: "km", category: "distance", tier: "easy" },
  { id: "dist_2",  name: "3 km am Stück",         xp: 120,    icon: "👟", stat: "longest_km",  target: 3,    unit: "km", category: "distance", tier: "easy" },
  { id: "dist_10", name: "4 km am Stück",         xp: 180,    icon: "👟", stat: "longest_km",  target: 4,    unit: "km", category: "distance", tier: "easy" },
  { id: "dist_3",  name: "5 km — die klassische", xp: 250,    icon: "🏃", stat: "longest_km",  target: 5,    unit: "km", category: "distance", tier: "easy" },
  { id: "dist_11", name: "6 km Dauerlauf",        xp: 320,    icon: "🏃", stat: "longest_km",  target: 6,    unit: "km", category: "distance", tier: "medium" },
  { id: "dist_4",  name: "7 km Läufer",           xp: 400,    icon: "🏃", stat: "longest_km",  target: 7,    unit: "km", category: "distance", tier: "medium" },
  { id: "dist_12", name: "8 km durchgezogen",     xp: 500,    icon: "💪", stat: "longest_km",  target: 8,    unit: "km", category: "distance", tier: "medium" },
  { id: "dist_5",  name: "10 km durchgelaufen",   xp: 700,    icon: "💪", stat: "longest_km",  target: 10,   unit: "km", category: "distance", tier: "medium" },
  { id: "dist_13", name: "12 km Langlauf",        xp: 900,    icon: "🎽", stat: "longest_km",  target: 12,   unit: "km", category: "distance", tier: "medium" },
  { id: "dist_6",  name: "15 km Ausdauer",        xp: 1200,   icon: "🏃", stat: "longest_km",  target: 15,   unit: "km", category: "distance", tier: "medium" },
  { id: "dist_14", name: "18 km Vorbereitung",    xp: 1600,   icon: "🏅", stat: "longest_km",  target: 18,   unit: "km", category: "distance", tier: "hard" },
  { id: "dist_7",  name: "Halbmarathon (21 km)",  xp: 2200,   icon: "🏅", stat: "longest_km",  target: 21.1, unit: "km", category: "distance", tier: "hard" },
  { id: "dist_8",  name: "25 km — Elite-Distanz", xp: 3000,   icon: "🏆", stat: "longest_km",  target: 25,   unit: "km", category: "distance", tier: "hard" },

  // ⚡ Tempo-Jäger (Marathon & Ultra)
  { id: "speed_1", name: "30 km Megalauf",        xp: 4000,   icon: "💨", stat: "longest_km",  target: 30,   unit: "km", category: "speed", tier: "hard" },
  { id: "speed_2", name: "Marathon (42 km)",      xp: 6000,   icon: "🥇", stat: "longest_km",  target: 42.2, unit: "km", category: "speed", tier: "epic" },
  ...
  { id: "end_9",   name: "25 km Gesamt",          xp: 100,    icon: "🌱", stat: "lifetime_km", target: 25,    unit: "km", category: "endurance", tier: "easy" },
  { id: "end_2",   name: "50 km Gesamt",          xp: 180,    icon: "🌿", stat: "lifetime_km", target: 50,    unit: "km", category: "endurance", tier: "easy" },
  { id: "end_3",   name: "100 km Meilenstein",    xp: 300,    icon: "🌳", stat: "lifetime_km", target: 100,   unit: "km", category: "endurance", tier: "easy" },
  { id: "end_10",  name: "150 km unterwegs",      xp: 450,    icon: "🌿", stat: "lifetime_km", target: 150,   unit: "km", category: "endurance", tier: "easy" },
  { id: "end_4",   name: "250 km Dauerläufer",    xp: 750,    icon: "🏞️", stat: "lifetime_km", target: 250,   unit: "km", category: "endurance", tier: "medium" },
  { id: "end_5",   name: "500 km Weltbummler",    xp: 1500,   icon: "🗺️", stat: "lifetime_km", target: 500,   unit: "km", category: "endurance", tier: "medium" },
  { id: "end_11",  name: "750 km gesammelt",      xp: 2300,   icon: "🏞️", stat: "lifetime_km", target: 750,   unit: "km", category: "endurance", tier: "medium" },
  { id: "end_6",   name: "1.000 km Club",         xp: 3200,   icon: "🌍", stat: "lifetime_km", target: 1000,  unit: "km", category: "endurance", tier: "hard" },
  { id: "end_12",  name: "1.500 km Kilometerfresser", xp: 5000, icon: "🌍", stat: "lifetime_km", target: 1500, unit: "km", category: "endurance", tier: "hard" },
  { id: "end_7",   name: "2.500 km Explorer",     xp: 8000,   icon: "🎖️", stat: "lifetime_km", target: 2500,  unit: "km", category: "endurance", tier: "epic" },
  ...
  { id: "str_2",   name: "3 Tage in Folge",       xp: 120,   icon: "🌟", stat: "streak_best", target: 3,   unit: "Tage", category: "streak", tier: "easy" },
  { id: "str_3",   name: "5 Tage in Folge",       xp: 250,   icon: "✨", stat: "streak_best", target: 5,   unit: "Tage", category: "streak", tier: "easy" },
  { id: "str_4",   name: "Eine Woche (7 Tage)",   xp: 400,   icon: "🔥", stat: "streak_best", target: 7,   unit: "Tage", category: "streak", tier: "medium" },
  { id: "str_11",  name: "10 Tage am Stück",      xp: 650,   icon: "✨", stat: "streak_best", target: 10,  unit: "Tage", category: "streak", tier: "medium" },
  { id: "str_5",   name: "2 Wochen (14 Tage)",    xp: 1000,  icon: "⚡", stat: "streak_best", target: 14,  unit: "Tage", category: "streak", tier: "medium" },
  { id: "str_12",  name: "21 Tage Gewohnheit",    xp: 1600,  icon: "⚡", stat: "streak_best", target: 21,  unit: "Tage", category: "streak", tier: "medium" },
  { id: "str_6",   name: "1 Monat (30 Tage)",     xp: 2500,  icon: "💥", stat: "streak_best", target: 30,  unit: "Tage", category: "streak", tier: "hard" },
  { id: "str_13",  name: "45 Tage Feuer",         xp: 4000,  icon: "🔥", stat: "streak_best", target: 45,  unit: "Tage", category: "streak", tier: "hard" },
  { id: "str_7",   name: "2 Monate (60 Tage)",    xp: 5500,  icon: "🌋", stat: "streak_best", target: 60,  unit: "Tage", category: "streak", tier: "hard" },
  { id: "str_14",  name: "90 Tage Durchhalter",   xp: 8000,  icon: "🌋", stat: "streak_best", target: 90,  unit: "Tage", category: "streak", tier: "epic" },
  ...
  { id: "con_2",   name: "5 Läufe absolviert",    xp: 120,   icon: "✅", stat: "total_walks", target: 5,    unit: "", category: "consistency", tier: "easy" },
  { id: "con_3",   name: "10 Läufe",              xp: 230,   icon: "🎯", stat: "total_walks", target: 10,   unit: "", category: "consistency", tier: "easy" },
  { id: "con_11",  name: "15 Läufe absolviert",   xp: 350,   icon: "✅", stat: "total_walks", target: 15,   unit: "", category: "consistency", tier: "easy" },
  { id: "con_4",   name: "25 Läufe",              xp: 550,   icon: "📈", stat: "total_walks", target: 25,   unit: "", category: "consistency", tier: "medium" },
  { id: "con_12",  name: "35 Läufe",              xp: 780,   icon: "🎯", stat: "total_walks", target: 35,   unit: "", category: "consistency", tier: "medium" },
  { id: "con_5",   name: "50 Läufe",              xp: 1100,  icon: "🎖️", stat: "total_walks", target: 50,   unit: "", category: "consistency", tier: "medium" },
  { id: "con_13",  name: "75 Läufe",              xp: 1600,  icon: "🎖️", stat: "total_walks", target: 75,   unit: "", category: "consistency", tier: "medium" },
  { id: "con_6",   name: "100 Läufe",             xp: 2200,  icon: "🏅", stat: "total_walks", target: 100,  unit: "", category: "consistency", tier: "hard" },
  { id: "con_14",  name: "150 Läufe",             xp: 3300,  icon: "🏅", stat: "total_walks", target: 150,  unit: "", category: "consistency", tier: "hard" },
  { id: "con_7",   name: "250 Läufe",             xp: 5500,  icon: "🏆", stat: "total_walks", target: 250,  unit: "", category: "consistency", tier: "hard" },
  { id: "con_15",  name: "365 Läufe — ein pro Tag", xp: 8000, icon: "📆", stat: "total_walks", target: 365,  unit: "", category: "consistency", tier: "epic" },
