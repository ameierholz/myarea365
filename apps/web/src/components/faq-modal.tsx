    ...
    items: [
      {
        ...
        a: <>Geh oder jogge durch deine Stadt. Jeder Straßenabschnitt den du abläufst wird auf der Karte markiert und gehört dir. Je mehr du läufst, desto mehr XP kassierst du und desto höher steigst du im Rang.</>,
      },
      {
        q: "Was ist der Unterschied zwischen Abschnitt, Straßenzug und Territorium?",
        a: <>
          <B color="#22D1C3">Straßenabschnitt</B> = kleinstes Stück Straße zwischen zwei Kreuzungen (50 XP).<br />
          <B color="#FFD700">Straßenzug</B> = eine komplette Straße, wenn du alle ihre Abschnitte hast (+250 XP Bonus).<br />
          <B color="#FF2D78">Territorium</B> = das Innere eines geschlossenen Rings aus mehreren Straßenzügen (+500 XP, nur mit Crew).
        </>,
      },
      {
      ...
      },
      {
        ...
        a: <>Ja. Solo-Runner sehen den geschlossenen Ring zwar grau gestrichelt auf der Karte (Anwartschaft), kassieren den 500-XP-Bonus aber erst, sobald sie einer Crew beitreten oder eine gründen. Das macht Crews wertvoll.</>,
      },
    ],
  },
  {
    ...
    items: [
      {
        q: "Wofür gibt es XP?",
        a: <>
          • <B>Neuer Straßenabschnitt</B>: 50 XP<br />
          • <B>Kompletter Straßenzug</B>: +250 XP Bonus<br />
          • <B>Geschlossenes Territorium</B> (Crew): +500 XP<br />
          • <B>Meilensteine</B> (erste 10 km, 30 Tage Streak etc.): extra Bonus<br />
          • <B>Arena-Sieg</B>: 25–75 XP je nach Level-Unterschied<br />
          • <B>Rewarded-Ad</B>: +100 XP Bonus auf deinen nächsten Lauf
        </>,
      },
      {
        q: "Gibt es XP für alte Straßen, die ich nochmal laufe?",
        a: <>Ja — aber gedrosselt, damit niemand farmt. 24 h nach dem ersten Claim: 0 XP (Cooldown). 1–7 Tage: 30 % des normalen Werts. 7–30 Tage: 60 %. Nach 30 Tagen: voller Wert wieder. Wird dir im Lauf-Summary transparent angezeigt.</>,
      },
      {
        q: "Wie steige ich im Rang auf?",
        a: <>Rang richtet sich nach Gesamt-XP. Vom <B>Straßen-Scout</B> (0 XP) bis zum <B color="#FFD700">Straßen-Gott</B> (250.000 XP) gibt es 10 Ränge mit eigenen Farben, Mottos und Rewards.</>,
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: <>Ja. Wenn eine feindliche Crew den Ring nachläuft und dabei mehr als 50 % der Segmente neu claimt, wechselt das Territorium die Farbe. Die alte Crew bekommt eine Benachrichtigung — Revanche ist möglich. Steal-Bonus: 1.5× XP für den Räuber.</>,
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: <>1v1 Wächter-Kämpfe gegen andere Runner. 5 Gratis-Kämpfe pro Tag, weitere gegen Diamanten. Gewinn = Siegel + Ausrüstung + XP für deinen Wächter. Verlust = kleine Ehre-Abzüge, nichts wird zerstört.</>,
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        q: "Was bringt MyArea+?",
        a: <>Premium-Abo mit Streak-Freeze-Vorrat, XP-Boost, Shop-Rabatt und exklusiven Map-Themes. Kündbar monatlich.</>,
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: <>Wir speichern nur den Minimalsatz (Strecken, XP, Profil). Keine Weitergabe. Vollständige DSGVO-Info im Datenschutz-Link im Profil-Footer.</>,
      },
      {
