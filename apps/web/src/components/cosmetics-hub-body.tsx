...
const SLOTS: Array<{
  ...
  { id: "base_ring",  label: "Avatar Rahmen", icon: "💍", color: "#22D1C3", hint: "Halo um den Avatar",   group: "base" },
  { id: "nameplate",  label: "Namensschild",  icon: "🎀", color: "#FF2D78", hint: "Schild mit deinem Namen", group: "base" },
