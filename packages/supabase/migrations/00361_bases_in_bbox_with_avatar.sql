-- ══════════════════════════════════════════════════════════════════════════
-- get_bases_in_bbox: liefert zusätzlich owner_avatar_url pro Runner-Pin,
-- damit die Karte das hochgeladene Profilbild als Base-Map-Icon anzeigen
-- kann (statt des Base-Theme-Artworks).
-- ══════════════════════════════════════════════════════════════════════════
