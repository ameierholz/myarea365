-- Fix: users.last_seen_at existiert nicht — Filter entfernt.
-- Inaktive User werden einfach nicht beschnitten; Matchmaker zieht aus allen.
...
begin
  ...
  -- 10 Gegner: aktive Wächter in ±3 Level, andere User (ohne last_seen-Filter)
